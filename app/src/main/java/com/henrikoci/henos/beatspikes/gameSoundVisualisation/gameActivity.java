...
public class gameActivity extends AppCompatActivity {
    ...
    //Permissions result code from picking audio file
    private static final int PICKFILE_RESULT_CODE = 1;

    //Method run when activity is created
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); //create bundle with savedState
        setContentView(R.layout.activity_game); //set view to activityGame layout
        Toolbar toolbar = findViewById(R.id.toolbar); //add support tooltip
        setSupportActionBar(toolbar);

        //add support for floating button
        FloatingActionButton fab = findViewById(R.id.fab);
        //set onclicklistener to floating button
        fab.setOnClickListener(new View.OnClickListener() {
            //display help tooltip when pressed
            @Override
        ...
        //button for import music
        Button buttonPick = findViewById(R.id.importMusic);

        //set button listener for trigger
        buttonPick.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //make a new intent with audio get content
                ...
                startActivityForResult(intentSelectAudio, PICKFILE_RESULT_CODE); //save result code
            }
        });
    }

    //required 'hack' to get the real URI path and not a encapsulated virtual file path.
    //researched hack! whole method from here to...
    private String getRealPathFromURI(Uri contentURI) {
        String result;
        Cursor cursor = getContentResolver().query(contentURI, null, null, null, null); //query URI
